...
def get_inout_estimates(dfday, obs_threshold=5, exitdistthreshold=1000,numtimedivs=288):  # dfday = dataframe containing data for one day, timedivs are in 5 minute bins
